  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#FAF1E6] text-blue-900">
      ...
      <div className="flex-grow flex flex-col items-center justify-center px-6 mt-24">
        {/* Collage Section */}
        <div className="flex flex-wrap justify-center gap-6 my-10 max-w-4xl">
          <img src={drew} alt="Drew" className="w-52 h-52 rounded-lg shadow-lg object-cover" />
          <img src={izzy2} alt="Izzy" className="w-52 h-52 rounded-lg shadow-lg object-cover" />
          <img src={izzypour} alt="Izzy Pouring" className="w-52 h-52 rounded-lg shadow-lg object-cover" />
        </div>
        ...
        <div className="text-center max-w-xl mb-7">
          ...
          <div className="flex flex-wrap justify-center gap-12">
            ...
            <div className="max-w-md text-center bg-white p-6 rounded-lg shadow-md">
              ...
              <h2 className="text-4xl font-bold text-gray text-center font-serif leading-tight tracking-wide">Izzy Bain</h2>
              <p className="text-2xl font-semibold text-gray-800 font-serif">
                Izzy is a passionate bartender with years of experience crafting exceptional cocktails.
              </p>
              <p className="mt-2 text-red-500 font-bold">Favorite Drink: Espresso Martini</p>
            </div>

            {/* Profile 2 */}
            <div className="max-w-md text-center bg-white p-6 rounded-lg shadow-md">
              <img src={drewpfp} alt="Drew" className="w-40 h-40 rounded-full shadow-md object-cover mb-4" />
              <h2 className="text-4xl font-bold text-gray text-center font-serif leading-tight tracking-wide">Drew Sailor</h2>
              <p className="text-2xl font-semibold text-gray-800 font-serif">
